    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          auth: path.resolve(__dirname, 'website/auth.html'),
          eventDetail: path.resolve(__dirname, 'website/event-detail.html'),
          dashboard: path.resolve(__dirname, 'website/dashboard.html'),
          profile: path.resolve(__dirname, 'website/profile.html'),
          admin: path.resolve(__dirname, 'website/admin.html'),
        },
      },
    },
    plugins: [
